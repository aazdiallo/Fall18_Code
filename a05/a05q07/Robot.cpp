...
{
    robot.energylevel += d; //Increment the energy level by the user input
}


void dec_energylevel(Robot & robot, int d)
{
    robot.energylevel -= d; //Decrement the energy level by the user input
}