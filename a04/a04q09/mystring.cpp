...
//Putting the first character of the user's name in lowercase
   ...
   void greeting_user( char h[])
   {
    ...
    void greeting_user(std::string m)
    {
        ...
        m[0] = char (m[0] +32); //putting first letter in lowercase
            ...
            if (m == "happy")
            {
                ...
                std::cout << "I'm glad. Tell me about your " << str_extract_name (y, x) << std::endl;
            }
            ...
            else if (m == "sad")
            {
                ...
                std::cin.getline(y, MAX_BUF);
                std::cout << "I'm sorry. Tell me about your " << str_extract_middle (y) << std::endl;
            }
    ...
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
    ...
    void random_first_response(std::string m)
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
        ...
        {
            case 1: 
                std::cout << "Hello " << m << ". How are you?" <<std::endl;
                break;
                
            case 2:
                std::cout << "Hi " << m << ". How you doing?" <<std::endl;
                break;
        }
    ...
    void random_secondH_response(std::string m) //When the user is happy
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
        ...
        switch (choice)
        {
            ...
            case 2:
                std::cout <<"I'm so glad to hear that. Why are you " << m << '?' << std::endl;
                break;
        }
    ...
    void random_secondS_response(std::string m) //When the user is sad
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
        ...
        switch (choice)
        {
            ...
            case 2:
                std::cout <<"I'm so sorry to hear that. Why are you " << m << '?' << std::endl;
                break;
        }
    ...
    void random_thirdH_response(std::string m) //When the user is happy
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
        ...
        {
            case 1: 
                std::cout <<"I'm glad to hear that. Tell me about your " << m << '?' << std::endl;
                break;
                
            case 2:
                std::cout <<"I'm so glad to hear that. Tell me about your " << m << '?' << std::endl;
                break;
        }
    ...
    void random_thirdS_response(std::string m) //When the user is sad
    {
        int choice  = rand()%2+1;     // choice in the range 1 to 2;
        ...
        {
            case 1: 
                std::cout << "I'm sorry. Tell me about your " << m << std::endl;
                break;
                
            case 2:
                std::cout << "I'm so sorry. Tell me about your " << m << std::endl;
                break;
        }
